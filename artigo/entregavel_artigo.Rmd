...
Dessa forma, justifica-se um estudo que compare diferentes modelos para a previsão de demanda. Neste estudo, dois modelos foram construídos e avaliados: o modelo gravitacional, pioneiro e amplamente utilizado, e modelos de aprendizagem de máquina, com a utilização de redes neurais e regressão linear múltipla.
