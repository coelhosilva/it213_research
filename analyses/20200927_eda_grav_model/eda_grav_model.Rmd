...
```{r importing_data}
print(getwd())
matriz_od_aerea <- read_parquet(here("data/bd_tele_processed/matriz_od_aerea.gz.parquet")) # matriz aérea processada em parquet
cidades <- read_parquet(here("data/bd_tele_processed/cidades.gz.parquet")) # cidades processada em parquet
cidades_geobr <- readRDS(here("data/extra/cidades_geobr.rds")) # Dados das cidades Brasileiras previamente capturados com o geobr (vide grab_cities_geobr.R)
```
